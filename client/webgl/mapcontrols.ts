...
export class MapControlCameraSystem extends System
{
	...
	startup()
	{
		this.controls = new MapControls(this.camera,this.world.getSingletonComponent(WebGLRenderer)!.domElement);
		this.controls.enableDamping = true;
		// this.controls.enableRotate = false;
		this.controls.maxDistance = 15;
		this.controls.minDistance = 5;

		for (const [, transform] of this.world.componentIterator(Transform, ActiveCameraComponent))
		{
