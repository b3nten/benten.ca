...
export class PixelPass extends Pass {
  ...
  render(renderer: WebGLRenderer, out: WebGLRenderTarget) {
    pixelationMaterial.uniforms["u_DiffuseMap"].value =
      this.colorRenderTarget.texture;
    pixelationMaterial.uniforms["u_DepthMap"].value =
      this.depthRenderTarget.texture;
    pixelationMaterial.uniforms["u_NormalMap"].value =
