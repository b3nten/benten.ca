...
class TransparentBackgroundFixedUnrealBloomPass extends Pass {
    ...
    render(renderer: WebGLRenderer, _: any, readBuffer: WebGLRenderTarget, __: any, maskActive: any) {
    ...
    getSeperableBlurMaterial(kernelRadius: number) {
        return new ShaderMaterial({
            defines: {
                KERNEL_RADIUS: kernelRadius, SIGMA: kernelRadius,
            },
...
export {TransparentBackgroundFixedUnrealBloomPass as TransparentBloom};