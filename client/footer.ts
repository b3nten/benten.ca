  ...
  render = () => html`
    ...
    <div class="container">
      <div class="grid">
        ...
        <div class="section">
          ...
          <ul class="links">
            ...
            <li>
              <a href="https://github.com/bentonboychuk" target="_blank"
                >Github</a
              >
            </li>
            <li>
              <a href="https://artstation.com/bentonboychuk" target="_blank"
                >Artstation</a
              >
            </li>
        ...
        <div class="section">
          ...
          <div class="terminal">
            ...
            <div class="terminal-line">
              > Status: ONLINE<span class="blink">_</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="bottom-bar">
        <div class="copyright">
          © ${new Date().getFullYear()} BENTON BOYCHUK-CHORNEY // ALL RIGHTS
          RESERVED
        </div>
        <div class="status">
